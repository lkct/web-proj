    ...
    for (i = 0; i < len; i++) {
        ...
        if (is_dir != 0) {
            para.innerHTML = '<section class="cd-section" style="margin-top: 50px;">'
                    ...
                    +'<li><a onclick="click_share(\''+filename+'\')">Share</a></li>'
                    +'<li><a onclick="click_cut(\''+filename+'\')">Cut</a></li>'
                    +'<li><a onclick="click_copy(\''+filename+'\')">Copy</a></li>'
                    +'<li><a onclick="click_enter(\''+filename+'\')">Enter</a></li>'
					+'<li><a></a></li>'
					+'<li><a></a></li>'
					+'</ul></nav>'
            ...
            para.innerHTML = '<section class="cd-section" style="margin-top: 50px;">'
                    ...
                    +'<li><a onclick="click_copy(\''+filename+'\')">Copy</a></li>'
					+'<li><a></a></li>'
					+'<li><a onclick="click_download(\''+filename+'\')">Download</a></li>'
					+'<li><a onclick="click_delete(\''+filename+'\')">Delete</a></li>'
					+'</ul></nav>'
					+'<a class="cd-close">Close modal</a></div>';
            element.appendChild(para);
        }
